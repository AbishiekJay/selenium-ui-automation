...
public class CustomDriver {
    ...
    public By getByType(String locator) {
        ...
        try {
            if (locatorType.contains("id")) {
                ...
                LOGGER.error("Locator type not supported");
            }
        } catch (Exception e) {
            LOGGER.error("By type not found with: " + locatorType);
        }
        return by;
    }
    ...
    public WebElement getElement(String locator, String info) {
        ...
        try {
            ...
            LOGGER.error("Element not found with: " + locator +" for "+ info);
            LOGGER.error(e);
        }
        return element;
    }
    ...
    public List<WebElement> getElementList(String locator, String info) {
        ...
        try {
            ...
            LOGGER.info("Element List found with: " + locator + " " + info);
        } catch (Exception e) {
            LOGGER.error("Element List not found with: " + locator + " " + info);
            LOGGER.error(e);
        }
        return elementList;
    }
    ...
    public void elementClick(WebElement element, String info, long timeToWait) {
        try {
            ...
            LOGGER.error("Cannot click on :: " + info);
    ...
    public void sendData(WebElement element, String data, String info, Boolean clear) {
        try {
            ...
            LOGGER.error("Cannot send keys on element :: "
                    + info + " with data :: " + data);
        }
    }
    ...
    public Boolean isEnabled(WebElement element, String info) {
        ...
        if (element != null) {
            ...
            if (enabled)
                ...
                LOGGER.error("Element :: " + info + " is NOT enabled");
        }
        return enabled;
    }
    ...
    public Boolean isDisplayed(WebElement element, String info) {
        ...
        if (element != null) {
            ...
            if (displayed)
                ...
                LOGGER.error("Element :: " + info + " is NOT displayed");
        }
        return displayed;
    }
    ...
    public Boolean isSelected(WebElement element, String info) {
        ...
        if (element != null) {
            ...
            if (selected)
                LOGGER.info("Element :: " + info + " is selected");
            else
                LOGGER.error("Element :: " + info + " is already selected");
        }
        return selected;
    }
    ...
    public void Check(WebElement element, String info) {
        if (!isSelected(element, info)) {
            ...
            LOGGER.error("Element :: " + info + " is already checked");
    }
    ...
    public void UnCheck(WebElement element, String info) {
        if (isSelected(element, info)) {
            ...
            LOGGER.error("Element :: " + info + " is already unchecked");
    }
    ...
    public boolean isOptionExists(WebElement element, String optionToVerify) {
        ...
        if (exists) {
            ...
            LOGGER.error("Selected Option : " + optionToVerify + " does not exist");
        }
        return exists;
    }
